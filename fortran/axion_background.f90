!!!!!!!!!!!!!!!! axion_background !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
! This module computes the evolution of the background in the presence of an 
! axion field
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
! This code The Klein-Gordon equation for a scalar field in an expanding universe
! (including
...
! from GH issue https://github.com/dgrin1/axionCAMB/issues/6 
! thanks to user 'astralsight' and Yilun Gua

! RH notes:
! Want to clean up integrator in package
! want to make references clearer to axion background in other parts of the code
! Clean up the inputs/outputs
...
integer badflag 
! flag for failed histories where H becomes negative (axion drives collapse). Flag is raised in derivs routine.
integer i 
